...
const representativeSchema = z.object({
  ...
  representativeDocument: z.string().nullable(),
  representativeDocumentNumber: z.string().nullable(),
  representativeIssuingAuthority: z.string().nullable(),
  representativeIssueDate: z.string().nullable(),
  representativeExpirationDate: z.string().nullable(),
...
type FormValues = z.infer<typeof representativeSchema>;
...
function Representative() {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      representativeDocumentNumber: null,
      representativeIssuingAuthority: null,
      representativeIssueDate: null,
      representativeExpirationDate: null,
      email: null,
      phone: null,
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <Select onValueChange={field.onChange} defaultValue={field.value || ''}>
                          <FormControl>
                            <SelectTrigger>
                              <SelectValue placeholder={t('relationshipDegree')} />
                            </SelectTrigger>
                          </FormControl>
                          <SelectContent>
                ...
                {form.watch('relationshipDegree') && (
                  <>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <FormField
                        control={form.control}
                        name="representativeExpirationDate"
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>{tDocument('expirationDate')}</FormLabel>
                            <FormControl>
