...
export const OpenAIResponse = ({
  ...
  const analyzeImages = async (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      //  1 если Министерство Юстиции РК |ҚР Әділет Министрлігі | Ministry of Justice of the RK
      // 2 если Министерство внутренних дел РК | ҚР Ішкі Істер министрлігі | The Ministry of Internal Affairs of the RK
      // во всех остальных случаях 3 Другой уполномоченный орган | Басқа уәкілетті орган | Another authorized authority
...
- Орган, выдавший документ (issuingAuthority) возвращай только '1' или '2' или '3' - 1 если Министерство Юстиции РК |ҚР Әділет Министрлігі | Ministry of Justice of the RK, 2 если Министерство внутренних дел РК | ҚР Ішкі Істер министрлігі | The Ministry of Internal Affairs of the RK, во всех остальных случаях 3 Другой уполномоченный орган | Басқа уәкілетті орган | Another authorized authority
